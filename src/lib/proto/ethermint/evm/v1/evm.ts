...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.allowUnprotectedTxs)) obj.allowUnprotectedTxs = Boolean(object.allowUnprotectedTxs);
    if (Array.isArray(object?.activePrecompiles))
      obj.activePrecompiles = object.activePrecompiles.map((e: any) => String(e));
...
export const ChainConfig = {
  ...
  fromJSON(object: any): ChainConfig {
    ...
    if (isSet(object.grayGlacierBlock)) obj.grayGlacierBlock = String(object.grayGlacierBlock);
    if (isSet(object.mergeNetsplitBlock)) obj.mergeNetsplitBlock = String(object.mergeNetsplitBlock);
    if (isSet(object.shanghaiBlock)) obj.shanghaiBlock = String(object.shanghaiBlock);
...
export const TraceConfig = {
  ...
  fromJSON(object: any): TraceConfig {
    ...
    if (isSet(object.tracerJsonConfig)) obj.tracerJsonConfig = String(object.tracerJsonConfig);
    return obj;
  },
